...
EXERCISES: list[Exercise] = [
    ...
    Exercise(
        ...
        name="Tennis Ball Grip Squeeze",
        category="upper",
        description="Hold a tennis ball in one hand, squeeze firmly, hold briefly, then release with control.",
        correct_form="Wrist neutral (not bent), fingers wrap fully around the ball, smooth squeeze and release, shoulders relaxed.",
        common_mistakes=[
            "Shrugging shoulder while squeezing",
            "Bending wrist excessively",
            "Using jerky or very fast squeezes",
            "Not fully releasing between reps",
            "Holding breath during effort",
        ],
        phases=["hand_open", "squeezing", "hold", "releasing"],
        rep_start_phase="hand_open",
        rep_end_phase="releasing",
    ),
    Exercise(
        id="ball_wall_press",
        name="Ball Wall Press",
        category="upper",
        description="Place a small ball against a wall with your palm at shoulder height, press into the wall, hold briefly, then relax pressure.",
        correct_form="Stand tall, shoulder down and back, elbow slightly bent, press steadily into the ball without trunk rotation.",
        common_mistakes=[
            "Leaning body into the wall instead of pressing from shoulder/arm",
            "Elevating shoulder toward ear",
            "Locking elbow fully",
            "Twisting trunk during press",
            "Pressing too hard with pain",
        ],
        phases=["setup", "pressing", "holding", "releasing"],
        rep_start_phase="setup",
        rep_end_phase="releasing",
    ),
    Exercise(
        ...
        category="upper",
        description="Anchor a resistance band in front of you, pull elbows back to row, squeeze shoulder blades, then return slowly.",
        correct_form="Neutral spine, chest lifted, elbows track close to body, shoulder blades retract smoothly, controlled return.",
        common_mistakes=[
            "Rounding upper back",
            "Shrugging shoulders",
            "Elbows flaring too wide",
            "Using momentum / rocking torso",
            "Snapping band back too quickly",
        ],
        phases=["arms_extended", "pulling", "row_end", "returning"],
        rep_start_phase="arms_extended",
        rep_end_phase="returning",
    ),
    Exercise(
        id="seated_towel_knee_slide",
        name="Seated Towel Knee Slide",
        category="lower",
        description="Sit in a chair with foot on a towel, slide foot back to bend the knee, then slide forward to straighten.",
        correct_form="Sit upright, heel stays in contact with towel, smooth controlled motion, avoid hip hiking.",
        common_mistakes=[
            "Leaning trunk excessively to compensate",
            "Lifting foot off the towel",
            "Moving too quickly without control",
            "Not reaching comfortable end range",
            "Twisting knee inward or outward",
        ],
        phases=["knee_extended", "sliding_back", "knee_bent", "sliding_forward"],
        rep_start_phase="knee_extended",
        rep_end_phase="sliding_forward",
    ),
]
